...
class PlayerSession{
	...
	private function sendWindow() : bool{
		...
		try{
			...
			InvMenuHandler::getRegistrant()->getLogger()->debug("muqsit failed to send inventory to " . $this->player->getName() . " due to: " . $e->getMessage());
			$this->removeWindow();
		}
	...
	/**
	 * @internal use muqsit::send() instead.
	 *
